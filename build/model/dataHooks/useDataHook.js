 ...
 */
export var useDataHook = function (forceRefreshTime) {
    // A fake state in order to fore an update
    var _a = useState(), update = _a[1];
    ...
    useEffect(function () { return function () { return dependencyRemovers.current.forEach(function (remove) { return remove(); }); }; }, []);
    return [
